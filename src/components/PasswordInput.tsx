  ...
  return (
    <div className={cn('relative', className)}>
      ...
      <input
        ...
        disabled={disabled}
        className={cn(
          'w-full pl-12 pr-12 py-4 bg-surface dark:bg-surface-variant border-none rounded-2xl shadow-inner outline-none focus:ring-2 focus:ring-primary/50 transition-all text-text-primary disabled:opacity-60',
          inputClassName
        )}
      />
      <button
