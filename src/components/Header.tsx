...
const Header = ({ portal = 'platform_admin' }: HeaderProps) => {
  ...
  return (
    <header className="sticky top-0 z-40 flex items-center justify-between h-16 px-4 sm:px-6 bg-[var(--header-bg)] backdrop-blur-xl border-b border-border transition-colors text-[var(--header-text)] shrink-0">
